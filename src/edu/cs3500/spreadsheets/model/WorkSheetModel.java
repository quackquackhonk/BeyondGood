...
public class WorkSheetModel implements IWorkSheetModel<CellContents> {
     ...
     * loc is the coordinates of the cell
     *
     * @return the {@code CellContents} at the provided location. Null if cell is blank, or not part of sheet.
     */
    @Override
     ...
     * col  represents the col number
     * row  represents the row number
     * cont the content of the cell
     *
    ...
    public static final class SheetBuilder implements
         ...
         * col      the column of the new cell (1-indexed)
         * row      the row of the new cell (1-indexed)
         * contents the raw contents of the new cell: may be {@code null}, or any string. Strings
